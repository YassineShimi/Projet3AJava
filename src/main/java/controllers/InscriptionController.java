...
public class InscriptionController {
    ...
    void savePerson(ActionEvent event) {
        ...
        Utilisateur p = new Utilisateur(Integer.parseInt(tfcin.getText()),tfnum_tel.getText(), tfnom.getText(), tfprenom.getText(), tfemail.getText(), tfmdp.getText(), rbmembre.isSelected() ? Role.USER : Role.ADMIN);
      ...
      //  String emailSubject = "Bienvenue sur notre plateforme";
       // String emailBody = "Bonjour " + p.getPrenom() + ",\n\nBienvenue sur notre plateforme Thakafa. Merci pour votre inscription.\n\nCordialement,\nL'équipe de notre plateforme.";
    ...
    private void sendWelcomeSMS(Utilisateur p) {
        ...
        Message message = Message.creator(
                ...
                new com.twilio.type.PhoneNumber("+18507504735"), // Twilio phone number
                "Bienvenue dans notre plateforme THAKAFA !"
        ).create();
    ...
    private File generateQRCode(String content) {
        ...
        try {
            ...
            qrCodeFile = new File("C:\\Users\\MSI\\IdeaProjects\\UsesrJava\\src\\main\\resources\\img\\logo.png.png");
