...
public class ProfilMembreController {
    ...
    void initialize() {
        ...
        if (utilisateur != null) {
            ...
            tfnum_tel.setText(String.valueOf(utilisateur.gettel()));
    ...
    private void modifierProfil() {
        ...
        Utilisateur u = new Utilisateur(id,cin, tel, nom, prenom, email, password,role);
