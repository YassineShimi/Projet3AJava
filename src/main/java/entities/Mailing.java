...
public class Mailing {
        ...
        public static void sendEmail(String recipient, String subject, String body) {
            ...
            String senderEmail = "yassine.shimi02@gmail.com"; // email address
            String senderPassword = "yexp xgds qbkj xhpy"; // email password
    ...
    public static void sendEmailWithAttachment(String recipientEmail, String subject, Multipart multipart) {
        ...
        String senderEmail = "yassine.shimi02@gmail.com";
        String senderPassword = "yexp xgds qbkj xhpy";
        ...
        public static void main(String[] args) {
            String recipient = "yassine.shimi02@gmail.com"; // Recipient's email address
